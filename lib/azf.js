...
var AZF = (function() {
    ...
    var check_permissions = function(auth_token, user_info, req, callback, callbackError, cache) {
        ...
        if (action === 'GET') {
            if (splitResource.includes('attrs')) {
                resource = 'v2/entities//attrs'
            }
            if (splitResource.includes('subscription')) {
                resource = 'v2/entities/subscription';
            }
            if (splitResource.includes('entities')) {
                resource = 'v2/entities';
            }
            if (splitResource.includes('types')) {
                resource = 'v2/types'
            }
        }
        ...
        if (action === 'DELETE') {
            ...
            if (splitResource.includes('subscriptions')) {
        ...
        if (action === 'PUT') {
            ...
            if (splitResource.includes('value')) {
                resource = 'v2/entities//attrs//value';
            }
        }
